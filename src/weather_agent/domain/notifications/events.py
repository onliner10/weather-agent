...
_FUNCTION_LABELS: dict[str, str] = {
    ...
    "avg_metric": "średnia",
    "sum_metric": "suma",
    "median_metric": "mediana",
    "stddev_metric": "odchylenie standardowe",
    "pctl_metric": "percentyl",
    "delta_metric": "zmiana",
    "abs_delta_metric": "bezwzględna zmiana",
    "rate_of_change_metric": "tempo zmiany",
    "forecast_delta_metric": "zmiana prognozy",
    "weekend": "weekend",
    "now": "teraz",
    "today": "dzisiaj",
    "tomorrow": "jutro",
    ...
    "between": "między",
    "points_between": "punkty w zakresie",
