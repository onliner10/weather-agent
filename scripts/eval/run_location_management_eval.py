"""Run location management fidelity evaluation in LangSmith.
...
async def _run() -> None:
    ...
    target = build_location_management_async_target_from_factory(
    ...
    results = await client.aevaluate(
        ...
        metadata={
            ...
            "evaluator": "deterministic_location_management_fidelity",
        },
        max_concurrency=4,
    )
